...
![Запрос: просмотр всех пользователей](docs/images/query_users.png)
...
![Моя машина](docs/images/my_car.png)
...
Если у пользователя есть особое (уникальное) название своей машины, его можно вписать или же пропустить (для этого в клавиатуре будет клавиша «Пропустить»):

![Пропустить](docs/images/skip.png)

После выбора авто, оно отобразится и присвоится пользователю, а блок клавиш сменится на действия с данным автомобилем:
...
![Расходы](docs/images/expenses2.png)

![Расходы](docs/images/expenses3.png)
...
![Расходы](docs/images/expenses4.png)

![Расходы](docs/images/expenses5.png)

![Расходы](docs/images/expenses6.png)

![Расходы](docs/images/expenses7.png)

![Расходы](docs/images/expenses8.png)
